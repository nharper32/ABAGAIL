...
public class PeaksRandOpt {
  ...
  public static void continuousPeaks(int N, int T) {

    System.out.println("CONTIUOUS PEAKS OPTIMZATION PROBLEM:");
    ...
    EvaluationFunction eval_func = new ContinuousPeaksEvaluationFunction(T);
    ...
    // int[] numIterationsRHC = {1, 10, 20, 30, 40, 50, 100, 200, 500, 700, 1000, 2000, 5000, 10000, 20000};
    //
    // for (int i=0; i < 3; i++) {
    //
    ...
    //
    // int[] numIterations = {1, 10, 20, 30, 40, 50, 100, 200, 500, 700, 1000, 2000, 5000, 10000, 20000};
    //
    // for (int i=0; i < 3; i++) {
    //
    //   System.out.println("Run: " + i);
    ...
    //
    //     SimulatedAnnealing sim_anneal = new SimulatedAnnealing(temp, .90, hill_climbing);
    ...
    for (int i=0; i < 3; i++) {
      ...
      for (int iterations: numIterationsGA) {
        ...
        StandardGeneticAlgorithm stand_gen =new StandardGeneticAlgorithm(10000, 10000/2, 10000/20, gen_alg);
    ...
    //
    // int[] samples = {500, 200, 150, 100, 50, 40, 30};
    ...
    //
    //     MIMIC mimic = new MIMIC(200, 20, prob_opt);
